...
Все, что надо знать для начала работы с библиотекой описано в файле gosttt.h
...
к макросу вызова единичного шага криптопреобразования, для чего в файле gosttt установить
...
_GOST_ROT_Synchro_GAMMA=0 в gosttt.
@param *Synchro - Указатель на данные для шифрования, также сюда заносится результат.
*/
