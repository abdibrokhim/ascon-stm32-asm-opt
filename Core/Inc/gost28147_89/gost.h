...
void GOST_Crypt_32_E_Cicle_Opt_A(GOST_Data_Part *DATA, GOST_Subst_Table Table, uint32_t *GOST_Key);

void GOST_Crypt_32_D_Cicle_Opt_A(GOST_Data_Part *DATA, GOST_Subst_Table Table, uint32_t *GOST_Key);
